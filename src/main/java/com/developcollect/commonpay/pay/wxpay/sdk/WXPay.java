...
public class WXPay {
    ...
    public Map<String, String> fillTransferRequestData(Map<String, String> reqData) throws Exception {
    ...
    public Map<String, String> transfer(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_TRANSFER_URL_SUFFIX;
        } else {
            url = WXPayConstants.TRANSFER_URL_SUFFIX;
        }
